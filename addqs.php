...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Calibri', Calibri, monospace;color:#fff !important">
    <div style="background-color: #f7c1bc;height: 100%;">
            ...
            <section id="ans">
                <center>
                    <form style="margin: 0vw;width: 100vw" method="post">
                        ...
                        <label for="quizname" style="color:#000000"><b><h2>Add Questions</h2></b></label><br><br>
                        <div id="QS" style="color:#000000">
                        ...
                        <input type="submit" name="submit" value="Add 1 more question" style="height: 3vw;width: auto;font-family: 'Calibri', Calibri monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;padding-right: 2vw; background-color: lightblue;">
                        <input type="submit" name="submit1" value="Done" style="height: 3vw;width: auto;font-family: 'Calibri', Calibri, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;padding-right: 2vw; background-color: lightblue;">
                    </form>
                </center>
            </section>
        </section>
