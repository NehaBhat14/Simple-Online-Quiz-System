    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        if (isset($_POST['login'])) {
            if (isset($_POST['usertype']) && isset($_POST['username']) && isset($_POST['pass'])) {     
                ...
                $password = crypt($password, 'dbmsminiprojectexam');
...
<body style="margin:0;height: 100%;ouline:none;color: #042A38f !important;padding-botton:5vw;background-image: url(./images/quiz1.jpg);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover; background-opacity: 0.9">
    <div class="bg" style="font-weight: bolder;font-family: 'Calibri', Calibri, monospace;opacity: 0.9;height: 100%;">
        <center>
            <h1 class="w3-container" style=" color:#fff;text-transform: uppercase;width: auto;background:#000000;padding: 1vw;"><b><u>ONLINE
                Examination System</u></b></h1>
        </center>
        <center>
            <div class="w3-card" class="login" style="color: #042A38;width: 40vw;background-color: #fff;border: 2px solid black;padding: 2vw;font-weight: bolder;margin-top: 10vh;border-radius: 10px;">
                <form method="POST">
                    <div class="seluser">
