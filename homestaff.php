...
session_start();
                ...
                $conn = mysqli_connect("localhost", "root", "", "project");if (!$conn) {
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Times New Roman', Times New Roman, monospace;height:auto; color:#000000">
    <div id="main" style="background-color: #ff9966;height: auto;color:#fff !important">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#042A38;position:fixed;">
            ...
            <ul style="display: inline-flex;padding: 0 !important;margin: 0;float: right;right: 0;position: fixed;width: 50vw;">
                ...
                <li onclick="score()">Quizzes</li>
                <li onclick="lo()">Sign Out</li>
            </ul>
        </div><br><br> 
        <center><section style="width:100vw;margin:0vw;margin-top:4vw;font-size:2vw;color: #000000">Welcome Staff:&nbsp;<?php echo $dbname ?></section></center>
        <section class="dash" style="margin: 5vw;width: 90vw;">
            <center><h1 style="font-weight:bolder;font-size:3vw; color: #000000">Dashboard</h1></center>
           ...
           <center>
            <section id="addq" style="display:none;">
                <form style="width: 30vw" method="post">
                        ...
                        <h1 style = "color:#000000">Add quiz</h1>
                        <label for="quizname" style = "color:#000000">Quiz name</label>
                        <input type="text" name="quizname" placeholder="enter quiz name" required><br><br>
                        <input type="submit" name="submit" value="submit" style="height: 3vw;width: 10vw;font-family: 'Times New Roman', Times New Roman, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
            ...
            <section id="delq" style="display:none;">
                <form style="margin: 1vw;width: 30vw" method="post">
                        ...
                        <h1 style = "color:#000000">Delete Quiz</h1>
                        <label for="quizid" style = "color:#000000">Quiz Id</label>
                        <input type="number" name="quizid" placeholder="enter quiz id" required><h7 onclick="score()" style="padding:0;color: #000000;font-size:1vw">     <u>Get Quiz ID</u></h7><br><br>
                        <input type="submit" name="submit1" value="submit" style="height: 3vw;width: 10vw;font-family: 'Times New Roman', Times New Roman, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
            ...
            <section id="viewq" style="display:none;">
                <form style="margin: 1vw;width: 30vw" method="post">
                        ...
                        <h1 style = "color:#000000">View Quiz</h1>
                        <label for="quizid" style = "color:#000000">Quiz Id</label>
                        <input type="number" name="quizid" placeholder="enter quiz id" required><h7 onclick="score()" style="padding:0;color: #000000;font-size:1vw">     <u>Get Quiz ID</u></h7><br><br>
                        <input type="submit" name="submit2" value="submit" style="height: 3vw;width: 10vw;font-family: 'Times New Roman', Times New Roman, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
        ...
        <section style="color:#000000 !important">
            <?php
