...
<body style="color: #fff !important;font-weight:bolder;margin: 0 !important;font-weight: bolder !important;font-family: 'Georgia', Georgia, monospace;">
    <div style="background-color: #000000;height: auto;">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#042A38;position:fixed;">
            ...
            <ul style="display: inline-flex;padding: 0 !important;margin: 0;float: right;right: 0;position: fixed;width: 50vw;">
                ...
                <li onclick="score()">Scoreboard</li>
        ...
        ?>
        <center><section style="width:100vw;margin:0vw;margin-top:5vw;font-size:3vw;">Welcome User:&nbsp;<?php echo $dbname ?></section></center>
        ...
        <?php 
            ...
            if($res)
            {
                echo "<center><h1 style=\"font-size:3vw;\">Take any Quiz</h1></center>";
                echo "<center><table><thead><tr><td>Quiz Title</td><td>Created By</td><td>  </td></tr></thead>";
                while ($row = mysqli_fetch_assoc($res)) {                
                    echo "<tr><td>".$row["quizname"]."</td><td>".$row["mail"]."</td><td><a id=\"tq\" href='takeq.php?qid=".$row['quizid']."'>Take Quiz</button></tr>"; 
                }
                echo "</table></center>";
            }
            ?>
