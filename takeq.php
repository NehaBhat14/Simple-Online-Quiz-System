...
<style>
    ...
    #btn{
        height: 3vw;width: 10vw;font-family: 'Georgia', Georgia, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightpink;
    }
    table{
        width: 90vw;
        margin-left: 5vw;
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Georgia', Georgia, monospace;color: #000000">
    <div style="background-color: #abdbe3;height: auto;">
        ...
        $qid=$_GET["qid"];
            ...
            if(isset($_POST["submit"])){
                ...
                echo "<script>alert(\"You have scored ".$score." out of ".$count."\");</script>";
                ...
                if($res)
                {
                    ...
                    echo "<script>alert(\"Error occured when updating score in database".mysqli_error($conn)."\");</script>";
                }
        }
     } ?>
        </section>
