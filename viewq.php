...
<style>
    ...
    #btn{
        height: 3vw;width: 10vw;font-family: 'Georgia', Georgia, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;
    }
    table{
        width: 90vw;
        margin-left: 5vw;
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Georgia', Georgia, monospace;color: #fff;height:auto;">
    <div style="background-color: #ff6666;height: auto;">
        ...
        $qid=$_GET["qid"];
            ...
            if($res)
            {
                ...
                {
                    echo "No questions found under this quiz please return later";
        ...
        <?php 
            ...
            if($res)
            {
                echo "<h1>List of Quizzes added by you</h1>";
