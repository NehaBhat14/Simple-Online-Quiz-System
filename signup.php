...
if (isset($_POST['studsu'])) {
    ...
    if (isset($_POST['name1']) && isset($_POST['usn1']) && isset($_POST['mail1']) && isset($_POST['phno1']) && isset($_POST['dept1']) && isset($_POST['dob1']) && isset($_POST['gender1']) && isset($_POST['password1']) && isset($_POST['cpassword1'])) {
        ...
        $password1 = crypt($password1,'dbmsminiprojectexam');
        $cpassword1 = crypt($cpassword1,'dbmsminiprojectexam');
        if ($password1 == $cpassword1) {
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                echo "<script>
                alert('Data entered by you alreay exists in the Database. Please Sign In');
                window.location.replace(\"index.php\");</script>";
                session_destroy();
            }
        } else {
...
if (isset($_POST['staffsu'])) {
    ...
    if (isset($_POST['name2']) && isset($_POST['staffid']) && isset($_POST['mail2']) && isset($_POST['phno2']) && isset($_POST['dept2']) && isset($_POST['dob2']) && isset($_POST['gender2']) && isset($_POST['password2']) && isset($_POST['cpassword2'])) {
        ...
        $password2 = crypt($password2,'dbmsminiprojectexam');
        $cpassword2 = crypt( $cpassword2,'dbmsminiprojectexam');
...
<body style="margin: 0;padding: 0;outline: none;height: 100%;min-height: 100%;color: #042A38 !important">
    <div style="font-family: 'Calibri', Calibri, monospace;margin: 0;padding: 0;background-color: #fff;height: 100%;width: 100%;padding-bottom: 5vw;background-image: url(images/pastelbg.jpg);height: auto !important;background-repeat: no-repeat;background-size:cover;">
        <center>
            <h1 style="text-transform: uppercase;padding: 2vw;background-color: #fff;color: #042A38;margin-top:0;">ONLINE
                Examination System</h1>
        </center>
        <div class="seluser">
            <center> <button onclick="stud()"><h3>STUDENT</h3></button><button onclick="staff()"><h3>STAFF</h3></button></center>
        </div>
        ...
        <center><a href="index.php" style="color:#000000 !important;">Cancel</a></center>
    </div>
